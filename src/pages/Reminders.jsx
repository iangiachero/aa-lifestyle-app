    ...
    <div className="min-h-full pb-8">
      <div className="relative border-b-2 border-[rgba(201,169,98,0.25)] page-safe-x py-6">
        ...
        <div className="w-full text-center">
          <h1 className="text-3xl text-[color:var(--app-gold)] font-light tracking-wide">Reminders</h1>
        </div>
      </div>

      <div className="page-safe-x pt-6">
        <p className="text-[color:var(--app-text-2)]">Reminders page content will be added here.</p>
      </div>
    </div>
  );
}
