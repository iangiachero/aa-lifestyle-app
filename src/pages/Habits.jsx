  ...
  return (
    <div className="min-h-full pb-24">
      ...
      <div className="page-safe-x pt-5">
        {/* Progress bar */}
        {habits.length > 0 && (
          <div className="mb-5 border border-[rgba(201,169,98,0.25)] rounded-2xl px-5 py-4" style={{ backgroundColor: 'var(--app-surface)' }}>
                  ...
                  <motion.div
                    ...
                    className={`relative overflow-hidden rounded-2xl border cursor-pointer transition-all duration-200 ${
                      isCompleted
                        ...
                        : 'border-[rgba(201,169,98,0.2)] bg-[color:var(--app-surface)]'
                    }`}
