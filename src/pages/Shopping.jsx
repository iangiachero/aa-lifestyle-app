    ...
    <div className="w-full min-h-full bg-[color:var(--app-bg)]">
      <div className="relative border-b-2 border-[rgba(201,169,98,0.25)] page-safe-x py-6">
        ...
        <div className="w-full text-center">
          <h1 className="text-3xl text-[color:var(--app-gold)] font-light tracking-wide">Shopping</h1>
        </div>
      </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {item.priority === 'high' && !item.checked && (
                            <span className="text-xs px-2 py-0.5 rounded-full uppercase tracking-wider mt-1 inline-block" style={{ backgroundColor: ui.wash2, color: 'var(--app-gold)' }}>
                              High
                            </span>
                          )}
                        </div>
